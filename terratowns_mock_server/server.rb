...
#Anything starting with dollar sign is a global variable.
...
class Home
  ...
  # It is used as an ORM. It has a module with ActiveModel that provides validations
  # The production Terratowns server is rails and uses very similar
  # and in most cases identical validations
...
# turn this generic class to utilizr the sinatra web-framework
class TerraTownsMockServer < Sinatra::Base
  ...
  def find_user_by_bearer_token
    ...
    # was there a user_uuid in body payload json?
  ...
  get '/api/u/:user_uuid/homes/:uuid' do
    ...
    content_type :json
    # does the uuid for the home match the one in our home
